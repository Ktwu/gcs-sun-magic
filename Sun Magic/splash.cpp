...
namespace sun_magic {
	...
	void Splash::RegisterState(MachineState<ref::GameState>* previousState) {
		game_state_ = ref::LOADING;

		GameAssetManager* manager = GameAssetManager::GetInstance();
		background_.setTexture(*manager->GetTexture(texture_refs::tutorial::poster_away));
	...
	void Splash::UnregisterState(MachineState<ref::GameState>* previousState) {
		GameAssetManager* manager = GameAssetManager::GetInstance();
		manager->ReturnTexture(texture_refs::tutorial::poster_close);
	}

	ref::GameState Splash::Update(float elapsed_time) {
